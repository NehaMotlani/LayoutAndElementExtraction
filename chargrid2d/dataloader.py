...
class SegDataset(Dataset):
    def __init__(self, root, list_file_name_path, size=(512, 512), transform=None):
        ...
        # input
        self.lbl_fol = osp.join(root, 'label_temp')
        self.img_fol = osp.join(root, 'img_temp')
    ...
    def __getitem__(self, idx):
        ...
        return img, mask, boxes, lbl_boxes  # boxes, lbl_boxes
...
if __name__ == "__main__":
    ...
    dataset = SegDataset('/home/pushpa/Documents/research/funsd_chargrid/funsd_chargrid/chargrid2d-icdar/data/', 'train_files.txt', transform=aug)
