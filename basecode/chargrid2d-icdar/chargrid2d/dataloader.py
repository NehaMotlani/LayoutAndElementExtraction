...
if __name__ == "__main__":
    ...
    dataset = SegDataset('/Users/nehamotlani/Desktop/College_Courses/Research/Repo/LayoutAndElementExtraction/basecode/chargrid2d-icdar/data/', 'train_files.txt', transform=aug)
