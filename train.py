...
def train(weights_folder='/home/pushpa/Documents/research/funsd_chargrid/funsd_chargrid/chargrid2d-icdar/data/weights'):
    N_EPOCHS = 30
    best_loss = np.infty

    dataloader = ChargridDataloader(root='/home/pushpa/Documents/research/funsd_chargrid/funsd_chargrid/chargrid2d-icdar/data', list_file_name_path='train_files.txt',
